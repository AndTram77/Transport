...
## Workspace: AndreyT
**Owner:** Андрей Т
**GitHub:** AndTram77 (`gh auth switch -u AndTram77`)
**Workspace правила:** /home/hive/projects/CLAUDE.md
**При старте:** "Привет, Андрей! (Transport CRM загружен, workspace AndreyT)"
...
**При каждом запуске:**
1. Приветствие с идентификацией workspace (см. выше)
2. Прочитай `PROGRESS.md` — там текущий статус, последняя сессия и следующий шаг
3. Прочитай `memory/MEMORY.md` — индекс сохранённых решений
4. Кратко сообщи пользователю: где мы остановились и что делаем дальше
5. Жди подтверждения или новой задачи
